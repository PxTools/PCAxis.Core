...
#End Region
        ...
        Protected Friend Overrides Sub SetMeta(ByVal keyword As String, ByVal subkey As String, ByVal values As System.Collections.Specialized.StringCollection, ByVal meta As PXMeta, ByVal isDefaultLanguage As Boolean)
            Select Case keyword
